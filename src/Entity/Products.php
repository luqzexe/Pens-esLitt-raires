...
class Products
{
    ...
    #[Assert\Length(
        ...
        maxMessage: 'Le titre ne pas doit faire plus de {{ limit }} caractères'
    )]
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message: 'Le petite description ne peut pas être vide')]
    private ?string $minDescription = null;
    ...
    public function setMinDescription(string $minDescription): static
    {
